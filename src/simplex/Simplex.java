...
//        int dcolunas, dlinhas;
//
//        System.out.println("Quantas variaveis possui o problema?\n");
//        dcolunas = entrada.nextInt();
//
//        System.out.println("Quantas restricoes?\n");
//        dlinhas = entrada.nextInt();
//
//        String s2[] = new String[dcolunas + 2];
//        float[] C2 = new float[dcolunas];
//        float[][] A2 = new float[dlinhas][dcolunas];
//        float[] b2 = new float[dcolunas];
//
//        System.out.println("Problema de max ou min");
//
//        s2[0] = entrada.next();
//
//        System.out.println("Funcao objetivo");
//        for (int i = 0; i < C2.length; i++) {
//            C2[i] = entrada.nextFloat();
//        }
//
//        System.out.println("Entre com as restricoes");
//
//        for (int i = 0; i < dlinhas; i++) {
//            for (int j = 0; j < dcolunas; j++) {
//                System.out.print("X" + j);
//                A2[i][j] = entrada.nextFloat();
//            }
//
//            System.out.println("Entrar com sinal");
//            s2[i + 1] = entrada.next();
//
//            System.out.println("Entrar com b");
//            b2[i] = entrada.nextFloat();
//        }
//
//        System.out.print("\n\n\n\n\n\n\n");
//        Problema p3 = new Problema(A2, C2, b2, s2);
